...
export default function RoadmapTitle() {
  return (
    <div className="bg-cover flex flex-col items-center justify-center md:items-start md:justify-end rounded-[1rem] m-4 shadow-2xl md:h-[500px]" style={{ backgroundImage: `url(public/img/uni.jpeg)` }}>
